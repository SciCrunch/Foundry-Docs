...
**Note:** When one changes config.yml, run the above command again as well as the command below. This recreates all the necessary configuration files for the subsystems.
